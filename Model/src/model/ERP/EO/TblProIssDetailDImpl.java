...
// ---    Sat Nov 07 13:11:55 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TblProIssDetailDImpl extends EntityImpl {
    /**
    ...
    /**
     * Gets the attribute value for ProIssDetailId, using the alias name ProIssDetailId.
     * @return the value of ProIssDetailId
     */
    public BigDecimal getProIssDetailId() {
        return (BigDecimal) getAttributeInternal(PROISSDETAILID);
    }

    /**
     * Sets <code>value</code> as the attribute value for ProIssDetailId.
     * @param value value to set the ProIssDetailId
     */
    public void setProIssDetailId(BigDecimal value) {
        setAttributeInternal(PROISSDETAILID, value);
    }
    ...
    public TblProIssDetailImpl getTblProIssDetail() {
        return (TblProIssDetailImpl) getAttributeInternal(TBLPROISSDETAIL);
    }

    /**
     * Sets <code>value</code> as the associated entity TblProIssDetailImpl.
     */
    public void setTblProIssDetail(TblProIssDetailImpl value) {
