...
// ---    Sat Nov 07 13:19:05 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TblQcMImpl extends EntityImpl {
    /**
    ...
    public static final int IGPMID = AttributesEnum.IgpMId.index();
    ...
    /**
     * Gets the attribute value for IgpMId, using the alias name IgpMId.
     * @return the value of IgpMId
     */
    public BigDecimal getIgpMId() {
        return (BigDecimal) getAttributeInternal(IGPMID);
    }

    /**
     * Sets <code>value</code> as the attribute value for IgpMId.
     * @param value value to set the IgpMId
     */
    public void setIgpMId(BigDecimal value) {
        setAttributeInternal(IGPMID, value);
    }
    ...
    public RowIterator getTblQcD() {
        return (RowIterator) getAttributeInternal(TBLQCD);
    }

    /**
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getTblGrnM() {
        return (RowIterator) getAttributeInternal(TBLGRNM);
    }

    /**
     * @return the associated entity TblIgpMImpl.
     */
    public TblIgpMImpl getTblIgpM() {
        return (TblIgpMImpl) getAttributeInternal(TBLIGPM);
    }

    /**
     * Sets <code>value</code> as the associated entity TblIgpMImpl.
     */
    public void setTblIgpM(TblIgpMImpl value) {
