...
// ---    Sat Nov 07 12:39:21 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TblGinMImpl extends EntityImpl {
    /**
    ...
    public static final int FROMPROJECTID = AttributesEnum.FromProjectId.index();
    public static final int TODEPARTMENTID = AttributesEnum.ToDepartmentId.index();
    public static final int TOPROJECTID = AttributesEnum.ToProjectId.index();
    public static final int CREATEDDATE = AttributesEnum.CreatedDate.index();
    public static final int CREATEDBY = AttributesEnum.CreatedBy.index();
    public static final int UPDATEDDATE = AttributesEnum.UpdatedDate.index();
    public static final int UPDATEDBY = AttributesEnum.UpdatedBy.index();
    public static final int TBLGIND = AttributesEnum.TblGinD.index();
    ...
    /**
     * Gets the attribute value for FromProjectId, using the alias name FromProjectId.
     * @return the value of FromProjectId
     */
    public BigDecimal getFromProjectId() {
        return (BigDecimal) getAttributeInternal(FROMPROJECTID);
    }

    /**
     * Sets <code>value</code> as the attribute value for FromProjectId.
     * @param value value to set the FromProjectId
     */
    public void setFromProjectId(BigDecimal value) {
        setAttributeInternal(FROMPROJECTID, value);
    }
    ...
    /**
     * Gets the attribute value for ToProjectId, using the alias name ToProjectId.
     * @return the value of ToProjectId
     */
    public BigDecimal getToProjectId() {
        return (BigDecimal) getAttributeInternal(TOPROJECTID);
    }

    /**
     * Sets <code>value</code> as the attribute value for ToProjectId.
     * @param value value to set the ToProjectId
     */
    public void setToProjectId(BigDecimal value) {
        setAttributeInternal(TOPROJECTID, value);
    }
     ...
     */
    public RowIterator getTblGinD() {
        return (RowIterator) getAttributeInternal(TBLGIND);
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.ERP.EO.TblGinM");
    }
