...
// ---    Sat Nov 07 13:09:12 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TblProFgDetailImpl extends EntityImpl {
    /**
    ...
    public static final int PORQTY = AttributesEnum.PorQty.index();
    ...
    /**
     * Gets the attribute value for ProFgMasterId, using the alias name ProFgMasterId.
     * @return the value of ProFgMasterId
     */
    public BigDecimal getProFgMasterId() {
        return (BigDecimal) getAttributeInternal(PROFGMASTERID);
    }

    /**
     * Sets <code>value</code> as the attribute value for ProFgMasterId.
     * @param value value to set the ProFgMasterId
     */
    public void setProFgMasterId(BigDecimal value) {
        setAttributeInternal(PROFGMASTERID, value);
    }
    ...
    /**
     * Gets the attribute value for PorQty, using the alias name PorQty.
     * @return the value of PorQty
     */
    public BigDecimal getPorQty() {
        return (BigDecimal) getAttributeInternal(PORQTY);
    }

    /**
     * Sets <code>value</code> as the attribute value for PorQty.
     * @param value value to set the PorQty
     */
    public void setPorQty(BigDecimal value) {
        setAttributeInternal(PORQTY, value);
    }
