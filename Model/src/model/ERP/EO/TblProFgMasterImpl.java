...
// ---    Sat Nov 07 13:09:55 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TblProFgMasterImpl extends EntityImpl {
    /**
    ...
    public static final int PORMASTERID = AttributesEnum.PorMasterId.index();
    ...
    /**
     * Gets the attribute value for PorMasterId, using the alias name PorMasterId.
     * @return the value of PorMasterId
     */
    public BigDecimal getPorMasterId() {
        return (BigDecimal) getAttributeInternal(PORMASTERID);
    }

    /**
     * Sets <code>value</code> as the attribute value for PorMasterId.
     * @param value value to set the PorMasterId
     */
    public void setPorMasterId(BigDecimal value) {
        setAttributeInternal(PORMASTERID, value);
    }
     ...
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getTblFgTrnMaster() {
        return (RowIterator) getAttributeInternal(TBLFGTRNMASTER);
    }

    /**
     * @return the associated entity TblPorMasterImpl.
     */
    public TblPorMasterImpl getTblPorMaster() {
        return (TblPorMasterImpl) getAttributeInternal(TBLPORMASTER);
    }

    /**
     * Sets <code>value</code> as the associated entity TblPorMasterImpl.
     */
    public void setTblPorMaster(TblPorMasterImpl value) {
